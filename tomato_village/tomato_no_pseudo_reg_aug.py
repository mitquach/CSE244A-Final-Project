...
training_config = load_config("freeze10_explr_1en4_0.8_tomato_ext")
...
train_dataset = ImageDataset(os.path.join(data_prefix,'train/labeled'), label_csv=os.path.join(data_prefix,'train_labeled.csv'), transform=augmented_transform)
val_dataset = ImageDataset(os.path.join(data_prefix,'train/labeled'), label_csv=os.path.join(data_prefix,'train_labeled.csv'), transform=transform)
unlabeled_dataset = ImageDataset(os.path.join(data_prefix,'train/unlabeled'), label_csv=os.path.join(data_prefix,'unlabeled_training_labels.csv'), transform=augmented_transform)

tomato_train_dataset = ImageDataset(os.path.join(tomato_prefix,'train/'), label_csv=os.path.join(data_prefix,'tomato.csv'), transform=augmented_transform)
...
for epoch in range(start_epoch, num_epochs):
    ...
    # Skip using unlabeled data for this attempt
    if False: #(epoch > 3):
