# File from: https://github.com/facebookresearch/deit/blob/main/augment.py
# An implementation of the image augmentation techniques used to train their Deit III model
